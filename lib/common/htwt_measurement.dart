...
class HeightWeightMeasurementCard extends StatefulWidget {
  const HeightWeightMeasurementCard({
    Key? key,
  }) : super(key: key);

  @override
  HeightWeightMeasurementCardState createState() =>
      HeightWeightMeasurementCardState();
}

class HeightWeightMeasurementCardState
    extends State<HeightWeightMeasurementCard> {
                    ...
                    Padding(
                      ...
                      child: IntrinsicWidth(
                        child: Column(
                          children: [
                            Text(
                              AppLocalizations.of(context)!.hw,
                              style: TextStyle(
